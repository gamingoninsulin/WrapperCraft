...
class Ui_WrapperCraft(object):
    def setupUi(self, WrapperCraft):
        ...
        self.pushButton.setGeometry(QtCore.QRect(90, 290, 259, 23))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(40, 120, 382, 78))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(180, 220, 81, 51))
    ...
    def retranslateUi(self, WrapperCraft):
        ...
        self.pushButton.setText(_translate("WrapperCraft", "MIGRATE!"))
        ...
        self.label_ServerJar_3.setText(_translate("WrapperCraft", "Migrate A Server"))
        self.label_ServerJar_5.setText(_translate("WrapperCraft", "Choose Server Folder:"))
        self.ServerJar.setText(_translate("WrapperCraft", "Server Folder"))
